...
/**
 * Interface contains methods which are required to provide user's work with the
 * data storage.
 * 
...
public interface ClientDAO {
	 ...
	 * 
	 * @param user
	 *            {@link by.epamtr.totalizator.bean.entity.User} object
	 *            representing new user.
	 * @param login
	 *            user's login.
	 * @param password
	 ...
	 * 
	 * @param gameCouponId
	 *            Id of the currently available game coupon(status: Opened).
	 * @return {@link List} of {@link by.epamtr.totalizator.bean.entity.Event}
	 *         objects.
	 * @throws DAOException
	 *             if obtaining information from the data storage fails.
	 */
